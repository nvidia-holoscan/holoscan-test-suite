...
#       Script fails unless you're running on an IGX Orin Devkit.
#       MGX must have an NVME device on /dev/nvme0n1.
#
# NOTE:
#       Do NOT run this on your host machine, it will NUKE your /dev/nvme0n1
#       device.  This script does attempt to ensure that you're running on
#       an IGX Orin Devkit.
#
# USAGE:
#       bringup_nvme_igx_orin_devkit.sh
#
# EXIT STATUS:
...
source "check_igx_orin_devkit.sh"
